...
@IonicPage()
@Component({
  selector: 'page-new-report-gauge-tax-oil',
  templateUrl: 'new-report-gauge-tax-oil.html',
})
export class NewReportGaugeTaxOilPage {
  ...
  ionViewDidLoad() {
    this.webapi.getData('taxPercentOil?offcode='+this.offcode).then((data) => {
    ...
    this.webapi.getData('QuantityOil?offcode='+this.offcode).then((data) => {
