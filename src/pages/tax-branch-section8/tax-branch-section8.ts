...
@IonicPage()
@Component({
  selector: 'page-tax-branch-section8',
  templateUrl: 'tax-branch-section8.html',
})
export class TaxBranchSection8Page {
...
/* end  */
setData() {
 this.webapi.getData('MapColorRegion?budget_year=2561&region=08').then((data) => {
