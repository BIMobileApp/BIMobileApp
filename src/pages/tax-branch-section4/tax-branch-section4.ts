...
@IonicPage()
@Component({
  selector: 'page-tax-branch-section4',
  templateUrl: 'tax-branch-section4.html',
})
export class TaxBranchSection4Page {
...
/* end  */
setData() {
 this.webapi.getData('MapColorRegion?budget_year=2561&region=04').then((data) => {
 ...
 let provinceName; 
     ...
     if(provinceName==this.resProvince){
       this.Pkhonkhen = '#FDC07F';
     }else{
      this.Pkhonkhen = '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Pnongbuarumbhu = '#FDC07F';
     }else{
      this.Pnongbuarumbhu = '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Pmahasarakam = '#FDC07F';
     }else{
      this.Pmahasarakam = '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Pkarasin = '#FDC07F';
     }else{
        this.Pkarasin =  '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Pmookdahan = '#FDC07F';
     }else{
      this.Pmookdahan = '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Psakonnakhon = '#FDC07F';
     }else{
      this.Psakonnakhon =  '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Pnakronphanom = '#FDC07F';
     }else{
      this.Pnakronphanom =  '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Pnongkay =  '#FDC07F';
     }else{
      this.Pnongkay =  '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Pbuengkhan =  '#FDC07F';
     }else{
      this.Pbuengkhan = '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Pudonthani =  '#FDC07F';
     } else{
      this.Pudonthani =  '#E6E6E6';
     }
     if(provinceName==this.resProvince){
       this.Ploei =  '#FDC07F';
     } else{
