...
@IonicPage()
@Component({
  selector: 'page-tax-branch-section6',
  templateUrl: 'tax-branch-section6.html',
})
export class TaxBranchSection6Page {
   ...
   for (var i = 0; i < this.responseData.length; i++) {       
    ...
    let provinceName; 
     ...
     if(provinceName==this.resProvince){
       this.Pphetchabun = '#FDC07F';
     }
     if(provinceName==this.resProvince){
       this.Pphitsanulok = '#FDC07F';
     }
    /* if(provinceName==this.resProvince){
       this.Pphichit = '#FDC07F';
     }
     if(provinceName==this.resProvince){
       this.Pnakhon_sawan = '#FDC07F';
     }
     if(provinceName==this.resProvince){
       this.Pkamphaeng_phet = '#FDC07F';
     }
     if(provinceName==this.resProvince){
       this.Psukhothai = '#FDC07F';
     }
     if(provinceName==this.resProvince){
       this.Puthai_thani = '#FDC07F';
     }
     if(provinceName==this.resProvince){
       this.Ptak = '#FDC07F';
     } */
