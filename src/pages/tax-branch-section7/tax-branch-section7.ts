...
@IonicPage()
@Component({
  selector: 'page-tax-branch-section7',
  templateUrl: 'tax-branch-section7.html',
})
export class TaxBranchSection7Page {
...
/* end  */
setData() {
 this.webapi.getData('MapColorRegion?budget_year=2561&region=07').then((data) => {
