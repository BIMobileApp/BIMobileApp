...
@IonicPage()
@Component({
  selector: 'page-new-report-gauge-tax-sica',
  templateUrl: 'new-report-gauge-tax-sica.html',
})
export class NewReportGaugeTaxSicaPage {
  dateAsOff = "";
  respondData:any;
  respondData2:any;
  offcode: any;
  ...
  ionViewDidLoad() {
    this.webapi.getData('taxPercentSica?offcode='+this.offcode).then((data) => {
    ...
    this.webapi.getData('QuantitySica?offcode='+this.offcode).then((data) => {
